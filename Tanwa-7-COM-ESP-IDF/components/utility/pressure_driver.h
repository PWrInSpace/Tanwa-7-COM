...
typedef enum {
    PRESSURE_DRIVER_SENSOR_1_ADC_PIN = ADS1115_MUX_2_GND,
    PRESSURE_DRIVER_SENSOR_2_ADC_PIN = ADS1115_MUX_1_GND,
    PRESSURE_DRIVER_SENSOR_3_ADC_PIN = ADS1115_MUX_3_GND,
    PRESSURE_DRIVER_SENSOR_4_ADC_PIN = ADS1115_MUX_0_GND,
