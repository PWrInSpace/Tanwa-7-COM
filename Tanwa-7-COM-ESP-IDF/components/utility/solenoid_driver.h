...
#define SOLENOID_DRIVER_VALVE_COUNT 6
  ...
  {                                                 \
    ...
    .valves = {                                     \
        ...
        {SOLENOID_DRIVER_VALVE_ADD,                 \
         SOLENOID_DRIVER_VALVE_GPIO_PIN_VENT,        \
         SOLENOID_DRIVER_VALVE_STATE_CLOSE},        \
        {SOLENOID_DRIVER_VALVE_OXY,                 \
         SOLENOID_DRIVER_VALVE_GPIO_PIN_OXY,        \
         SOLENOID_DRIVER_VALVE_STATE_CLOSE},        \
        {SOLENOID_DRIVER_VALVE_OXY,                 \
         SOLENOID_DRIVER_VALVE_GPIO_PIN_FUEL,        \
         SOLENOID_DRIVER_VALVE_STATE_CLOSE},        \
        {SOLENOID_DRIVER_VALVE_OXY,                 \
...
typedef enum {
    ...
    SOLENOID_DRIVER_VALVE_VENT = 2,
    SOLENOID_DRIVER_VALVE_OXY = 3,
    SOLENOID_DRIVER_VALVE_FUEL = 4,
    SOLENOID_DRIVER_VALVE_ADD = 5
...
typedef enum {
    ...
    SOLENOID_DRIVER_VALVE_GPIO_PIN_VENT = 0,
    //SOLENOID_DRIVER_LED_GPIO_PIN_ADD = 3
    SOLENOID_DRIVER_VALVE_GPIO_PIN_OXY = 3,
    SOLENOID_DRIVER_VALVE_GPIO_PIN_FUEL = 4,
    SOLENOID_DRIVER_VALVE_GPIO_PIN_ADD = 5
